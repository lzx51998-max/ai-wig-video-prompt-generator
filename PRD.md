...
1. 用户提供一张人物参考图，人物已经佩戴需要展示的目标假发。
2. 用户提供一张背景参考图。
3. 用户选择视频创意类型。
4. 用户补充希望人物完成的动作、道具互动或场景要求；未补充时使用模板默认动作。
5. 产品生成可直接用于 Grok 的完整英文提示词。
6. 产品生成与英文内容对应的中文翻译，供用户理解和审核。
7. 产品在提示词末尾追加固定负面提示词。
8. 用户将参考图片和英文提示词提交至 Grok Imagine。
